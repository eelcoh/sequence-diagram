module Diagram.Render.Lifeline exposing (view)
...
import Diagram.Render.Line
import Diagram.Render.Point as Point
import Diagram.Types as Diagram exposing (..)
...
viewLifeline config attrs lifelineIdx lifelineLength =
    ...
    in
        Diagram.Render.Line.draw config l
